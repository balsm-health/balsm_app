...
/// ```dart
/// deletionStrings.current           // sync, active locale
/// await deletionStrings.load()      // deferred-safe, active locale
/// ```
/// Presentation should prefer the reactive provider in
/// `presentation/i18n/i18n.dart`.
final deletionStrings = LocalizedStrings<Messages>.defaultLangs(
