...
class AuthStrings_ar extends AuthStrings {
  ...
  String get ph_terms => "بالمتابعة فإنك توافق على شروط بَلسَم وسياسة الخصوصية.";
...
class CheckinStrings_ar extends CheckinStrings {
  ...
  String q_sym_h(Gender gender) => "${_select(gender, {
            ...
            'other': 'حرّك المؤشر لمستوى الألم، ثم اختر ما تشعر به.'
          })}";
  Object operator [](String key) {
    var index = key.indexOf('.');
    if (index > 0) {
...
class SettingsStrings_ar extends SettingsStrings {
  ...
  String get travel_help => "حدّد موقعك ليعرض بَلسَم أرقام الطوارئ ومعلومات الرعاية المحلية أثناء سفرك.";
